...
(function ($) {
  ...
  $.fn.imagePopup = function (options) {
    //imagePopup sarà il nome del nostro plugin, options riceve i valori da app.js

    //settings sarà la variabile usata per recuperare le properties di options
    //queste sono le properties di default
    var settings = $.extend(
      {
        //.extend, estendo le properties di options
        overlay: "rgba(0, 0, 0, 0.5)",
        closeButton: {
          //qui metto le properties di default del bottone close
          src: null,
          width: "30px",
          height: "30px",
        },
      ...
      options
    ); //options qui sostituirà il valore di overlay qui dentro
    ...
    return this.each(function () {
      ...
      $(this)
        ...
        .on("click", function (event) {
          ...
          if ($.isFunction(settings.open)) {
            //controllo che la property open sia not null
      ...
      $closeButton.click(function () {
        ...
        //grazie a questo, quando clicco sulla x(closeButton) mi nasconde l'overlay
